...
## Newsletter
- Para obter informações sobre o boletim informativo
    ``` ts
    ...
    ```
- Para atualizar a descrição de um boletim informativo
    ``` ts
    await sock.newsletterUpdateDescription("abcd@newsletter", "New Description")
    ```
- Para atualizar o nome de um boletim informativo
    ``` ts
    await sock.newsletterUpdateName("abcd@newsletter", "New Name")
    ```  
- Para atualizar a foto do perfil de uma newsletter.
    ``` ts
    await sock.newsletterUpdatePicture("abcd@newsletter", buffer)
    ```
- Para remover a foto do perfil de um boletim informativo
    ``` ts
    await sock.newsletterRemovePicture("abcd@newsletter")
    ```
- Para silenciar notificações de um boletim informativo.
    ``` ts
...
- Para silenciar notificações de um boletim informativo.
    ...
    ```
- Para criar um boletim informativo
    ``` ts
    const metadata = await sock.newsletterCreate("Newsletter Name", "Newsletter Description")
    console.log(metadata)
    ```
- Para excluir um boletim informativo.
    ``` ts
    await sock.newsletterDelete("abcd@newsletter")
    ```
- Para seguir um boletim informativo
    ``` ts
    await sock.newsletterFollow("abcd@newsletter")
    ```
- Para deixar de seguir uma newsletter
    ``` ts
